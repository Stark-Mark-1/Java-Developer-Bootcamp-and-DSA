public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(message);// Write your code here
         ...
         */
        String example = "Java";
        System.out.println(example.length());// Write your code here
        ...
        System.out.println(upperCase.toLowerCase());// Write your code here
        ...
        System.out.println(programming.startsWith("programming"));
        ...
        System.out.println(original.replace('a', 'b'));// Write your code here
        ...
        double number = 9;
        System.out.println(Math.sqrt(number)); //Write your code here
